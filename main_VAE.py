...
from VAE import VAE
from utils import sample_and_categorize, get_mnist_data
from XAI_classifier import xai_model
...
if __name__ == "__main__":
    ...
    # Fit the model. Note that the 'eps' input is ignored because it is an Input tensor.
    history = model_pre.model.fit([x_train, dummy_eps_input], x_train, shuffle=True, epochs=5, batch_size=100)
    # plot_learning_curve(history)
    ...
    cnn = load_model("./saved_model/CNN/cnnClassifier.h5")
